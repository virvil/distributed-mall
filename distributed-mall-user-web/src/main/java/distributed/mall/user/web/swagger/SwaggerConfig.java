package distributed.mall.user.web.swagger;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("distributed.mall.user.web.controller"))
    ...
    @Bean
    public FastDFSClientUtil fastDFSClientUtil()throws Exception{
